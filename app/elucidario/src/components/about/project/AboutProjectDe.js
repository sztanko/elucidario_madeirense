  ...
  return (
    <>
      <Text mb={4}>
        ...
        Einwohnern erlebt habe, fühle ich mich aus tiefstem Herzen verpflichtet,
        die historischen Beiträge ihrer bedeutendsten Denker auf die
        zugänglichste Art und Weise dieses digitalen Zeitalters zu bewahren und
        zu verbreiten. Diese Website ist ein persönliches Unterfangen, das ich
        in meiner Freizeit ohne jegliche Finanzierung durchführe. Es ist Open
        Source, und der Code ist hier verfügbar:{' '}
        <Link
      ...
      <Text mb={4}>
        ...
        meisten Fehler, die durch optische Zeichenerkennung entstanden sind, zu
        korrigieren, kann ich nicht garantieren, dass alle behoben wurden.
        Gelegentlich verschmelzen einige Artikel zu einem.
      </Text>
      <Text mb={4}>
        Für die Formatierung und anschließende Übersetzung des Textes wurden
        Großsprachmodelle wie ChatGPT und Claude verwendet. Ich erkenne an, dass
        keine Methode fehlerfrei ist und manchmal erhebliche Fehler in der
        Übersetzung und im Layout auftreten. Ich plane jedoch, den Inhalt erneut
        zu verarbeiten, wenn sich die Modelle verbessern. Alle Bilder wurden
        ebenfalls mit Hilfe von KI-Technologie generiert.
      </Text>
      <Text mb={4}>
        Mein Name ist Dimi, ich wohne in London, UK, und ich bin tief fasziniert
