...
export default function AboutProjectPt() {
  return (
    <>
      <Head>
        <title>Sobre este projeto - Elucidario Madeirense</title>
      </Head>
      <AppLayout locale="en">
        ...
        <Text mb={4}>
          Em apreço pelos momentos encantadores e pela calorosa hospitalidade
          que vivenciei na ensolarada ilha da Madeira e entre seus habitantes,
          ...
          mais acessível desta era digital. Este site é um empreendimento
          pessoal, realizado em meu tempo livre sem nenhum financiamento. É
          open source, e o código está disponível aqui: {' '}
          <Link
        ...
        <Text mb={4}>
          ...
          caracteres, não posso garantir que todos foram abordados. Ocasionalmente,
          alguns artigos se fundem em um.
        </Text>
        <Text mb={4}>
          ...
          tradução e no layout. No entanto, planejo reprocessar o conteúdo à medida
          que os modelos melhorarem. Todas as imagens também foram geradas usando
          tecnologia de IA.
        </Text>
        <Text mb={4}>
          ...
          entrar em contato comigo via e-mail em <Link href='mailto:sztanko@gmail.com'>sztanko@gmail.com</Link>.
        </Text>
